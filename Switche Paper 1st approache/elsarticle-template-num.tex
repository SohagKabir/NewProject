...
The performance of the approach is evaluated by applying it to a set of real biological datasets. The experiments yield that the proposed approach reduces the switching activity by $45.47\%$ in the best case, by $36.45\%$ in the average case, and by $16.42\%$ in the worst case. 
\end{abstract}
...
\UNTIL{the switching number stop decreasing}
%\algstore{myalg}
\end{algorithmic}
\end{algorithm}
...
\small
\label{table4}
\caption{Comparison of the total number of switches (in millions) between the Huffman code and the proposed approach}
%\begin{center}

\begin{tabular}{c  c c  c c  c c}
\hline
 Datasets & \begin{tabular}{@{}c@{}}Switches in the Huffman\\  Code (in millions)\end{tabular} & \begin{tabular}{@{}c@{}}Switches in the proposed\\  approach (in millions)\end{tabular}& Improvement (\%) \\\hline
...
%\end{center}
\end{table}
In the experiments, we compare the performance of the classical Huffman code with the performance of the proposed method in terms of the total number of switching. Table 2 presents the results obtained by the proposed approach and the classical Huffman code. The results are presented as the total number of switching activities in both the approaches and the improvement rate. The improvement rate (reduction ratio) is calculated as:\\
\begin{equation}
