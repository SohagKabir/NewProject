...
\author{Sohag Kabir\inst{1}\and Youcef Gheraibia\inst{2} \and Martin Walker\inst{1}\and Tanzima Azad\inst{3}}
\institute{Department of Computer Science, University of Hull, Hull, UK\and Department of Computer Science and Mathematics,  Mohamed-Cherif Messaadia University, Souk Ahras, Algeria\and Department of Computer Science and Engineering, Bangladesh University of Engineering \& Technology, Dhaka, Bangladesh\\
\email{s.kabir@hull.ac.uk, youcef.gheraibia@univ-soukahras.dz, Martin.Walker@hull.ac.uk, azad.tanzima@dbbl.com.bd}
}
\maketitle
...
\begin{figure}[thpb]
      \centering
      \framebox{
			\includegraphics[scale=0.60]{events1}%[scale=0.6]
 	  }
...
\begin{figure}[thpb]
      \centering
      \framebox{
			\includegraphics[scale=0.64]{gates1}%[scale=0.6]
 	  }
...
\begin{figure}[thpb]
      \centering
			...
			\includegraphics[scale=0.5]{example_FT1}%[scale=0.6]
